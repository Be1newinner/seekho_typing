...
export const lessons: Lesson[] = [
  {
    ...
    text: "asdf jkl; asdf jkl; asdf jkl; fjdk slfa jkl; asdf fjdk slfa asdf jkl; asdf jkl; fjdk slfa jkl; asdf fjdk slfa asdf jkl;"
  },
  {
    id: 2,
    title: "Lesson 2: Home Row Extended",
    description: "Practice all home row keys including G and H",
    text: "asdf ghjkl; asdf ghjkl; fghj fghj ghfj ghfj asdfjkl; ghjkl; asdfg hjkl; asdfg hjkl; fghj dksl asdfjkl; ghjkl; asdfg hjkl;"
  },
  {
    id: 3,
    title: "Lesson 3: Top Row Introduction",
    description: "Learn the top row keys Q W E R T Y U I O P",
    text: "qwer tyui op qwer tyui op wert yuio wert yuio qwerty qwerty uiop uiop qwer tyui op wert yuio qwerty uiop"
  },
  {
    id: 4,
    title: "Lesson 4: Top Row Practice",
    description: "Practice top row with home row combinations",
    text: "awe awe few few wet wet pet pet yet yet quiet quiet wrote wrote power power tower tower quiet wrote power tower"
  },
  {
    id: 5,
    title: "Lesson 5: Bottom Row Introduction",
    description: "Learn the bottom row keys Z X C V B N M",
    text: "zxcv bnm, zxcv bnm, xcvb nm,. zxcv bnm, xcvb nm,. zxcv bnm, xcvb nm,. zxcvbnm zxcvbnm bnm,. xcvb nm,. zxcv bnm,"
  },
  {
    id: 6,
    title: "Lesson 6: Bottom Row Practice",
    description: "Practice bottom row with mixed combinations",
    text: "cab cab box box van van mix mix zoo zoo calm calm zoom zoom cozy cozy next next calm zoom cozy next box van mix zoo"
  },
  {
    id: 7,
    title: "Lesson 7: All Three Rows",
    description: "Combine home, top, and bottom rows",
    text: "quick brown fox lazy dog jump quick brown fox lazy dog jump the quick brown fox jumps over the lazy dog"
  },
  {
    id: 8,
    title: "Lesson 8: Numbers Introduction",
    description: "Learn to type numbers 1-5",
    text: "123 234 345 123 234 345 12345 12345 54321 54321 123 234 345 12345 54321 123 234 345 12345 54321 123 234 345"
  },
  {
    id: 9,
    title: "Lesson 9: Numbers Extended",
    description: "Practice numbers 1-9 and 0",
    text: "1234567890 1234567890 0987654321 0987654321 123 456 789 0 123 456 789 0 1234567890 0987654321 123 456 789 0"
  },
  {
    id: 10,
